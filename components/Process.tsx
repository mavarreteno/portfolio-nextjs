    ...
    <section className="w-full py-20" id='process'>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
         ...
         description="This is where the magic happens! Based on the approveddescriptionign, 
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    ...
    <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-1 text-white backdrop-blur-3xl text-2xl font-bold">
        {order}
      </span>
    </button>
    </div>
